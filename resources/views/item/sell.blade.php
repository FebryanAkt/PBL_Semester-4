        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div class="md:col-span-5">
                    <div class="border-2 border-dashed border-gray-300 rounded-lg h-64 flex flex-col items-center justify-center bg-gray-50 relative">
                        ...
                        <input type="file" name="foto_utama" class="absolute inset-0 opacity-0 cursor-pointer">
                    </div>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="harga" placeholder="Rp " class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-bekas-green focus:border-bekas-green outline-none">
                </div>
