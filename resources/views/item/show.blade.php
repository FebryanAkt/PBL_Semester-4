    ...
    <div class="max-w-6xl mx-auto px-6 py-10 md:py-16">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="w-full md:w-1/2 p-6 md:p-10 flex flex-col">
                ...
                <p class="text-3xl font-black text-bekas-green mb-6 border-b border-gray-100 pb-6">Rp
                ...
                <div class="space-y-4 mb-8 flex-grow">
                    ...
                    <div class="flex items-center text-gray-600">
                        ...
                        <span class="font-medium">Dijual oleh: <span class="text-gray-900 font-bold">Mahasiswa
                                UB</span></span>
                    </div>
                ...
                <div class="mt-auto pt-6 flex flex-col gap-4" x-data="{ qty: 1 }">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        @if(Auth::check() && Auth::id() != ($item->user_id ?? 1))
                            <a href="{{ route('chat.show', ['id' => $item->user_id ?? 1, 'item_id' => $item->id]) }}"
