...
@section('content')
    <div class="min-h-screen bg-gray-100 py-10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(session('success'))
                <div
                    class="mb-6 bg-green-50 border-l-4 border-bekas-green text-green-700 p-4 rounded shadow-sm flex items-center gap-3">
            ...
            <div class="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div class="w-full md:w-1/3 lg:w-1/4 flex-shrink-0">
                    <div
                        class="bg-white rounded-xl shadow-sm p-6 flex flex-col items-center text-center border border-gray-100">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="relative mb-6 group cursor-pointer"
                                ...
                                <div
                                    class="w-32 h-32 rounded-full overflow-hidden border-4 border-gray-50 bg-gray-100 flex items-center justify-center relative">
                                    @if($user->avatar)
                                        <img id="avatar-preview" src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar"
                                            class="w-full h-full object-cover">
                                    @else
                                        <svg id="avatar-preview-icon" class="w-16 h-16 text-gray-300" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path
                            ...
                            <button type="submit" id="btn-upload"
                                class="w-full group bg-white border-2 border-bekas-green text-bekas-green hover:bg-bekas-green hover:text-white font-bold py-2 px-4 rounded-xl transition-all duration-300 text-sm mb-4 flex items-center justify-center gap-2 shadow-sm hover:shadow-md active:scale-95">
                                <svg class="w-4 h-4 transition-transform duration-300 group-hover:-translate-y-1"
                        ...
                        <div class="p-8">
                            <form action="{{ route('profile.update') }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">Asal
                                            Universitas</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor HP /
                                            WhatsApp</label>
                                        <div class="relative">
                                            <span
                                                class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500 font-medium">+62</span>
                                ...
                                <div>
                                    <button type="submit"
                                        class="group bg-bekas-green hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 active:scale-95 focus:outline-none focus:ring-4 focus:ring-green-700/30 flex items-center gap-2">
