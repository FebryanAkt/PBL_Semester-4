    ...
    <div class="flex items-center gap-4 md:gap-6 text-sm font-medium">
        ...
        @auth
            <div class="hidden md:flex items-center gap-6">
                <a href="{{ route('cart.index') }}" class="hover:text-bekas-green transition flex items-center relative group" title="Keranjang">
                    ...
                    @endphp
                    @if($cartCount > 0)
                        <span class="absolute -top-2 -right-2.5 bg-red-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full min-w-[18px] text-center border-2 border-bekas-dark leading-none flex items-center justify-center">
                            {{ $cartCount }}
                        </span>
                    @endif
                </a>
