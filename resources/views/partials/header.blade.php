<nav class="bg-bekas-dark text-white py-4 px-6 md:px-12 flex justify-between items-center shadow-md sticky top-0 z-50">
    ...
    <div class="hidden md:flex flex-1 max-w-xl mx-8 relative">
        <input type="text" placeholder="Cari barang Mahasiswa Malang"
            class="w-full py-2.5 px-4 rounded-lg text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-bekas-green">
    ...
    <div class="flex items-center gap-4 md:gap-6 text-sm font-medium">
        ...
        <div class="flex items-center gap-4">
            <a href="{{ route('profile.edit') }}"
                class="w-8 h-8 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center cursor-pointer hover:bg-white transition"
                title="Profil Anda">
